...
<div class="btn-container">
    ...
    <button class="link-button" onclick="window.location.href='insertsubject.php';">Insert Subjects</button>
    <button class="link-button" onclick="window.location.href='editsubject.php';">Edit Subjects</button>
</div>
