...
(34, 2, 19, '14:00:00', '16:00:00', 'monday', 'lab', 'S106', 'approved', '2023-08-27 17:51:29'),
(35, 2, 32, '12:00:00', '14:00:00', 'tuesday', 'lecture', 'S105', 'deny', '2023-08-27 17:54:35'),
(36, 2, 19, '14:00:00', '16:00:00', 'monday', 'lab', 'S106', 'approved', '2023-08-29 00:25:11'),
(37, 2, 33, '08:00:00', '10:00:00', 'friday', 'lecture', 'S105', 'approved', '2023-08-29 05:32:55'),
(38, 2, 48, '14:00:00', '16:00:00', 'monday', 'lecture', 'S103', 'approved', '2023-08-29 12:00:09'),
(39, 2, 32, '10:00:00', '12:00:00', 'tuesday', 'lecture', 'S103', 'deny', '2023-08-29 12:00:28'),
(40, 2, 33, '13:00:00', '15:00:00', 'friday', 'Lab', 'S101', 'approved', '2023-08-31 09:33:48');
...
('EC4', 'Intro to GHI', 'Diploma', 'Oct', 1, 'DCS'),
('EC5', 'ABCDEFG', 'diploma', 'oct', 1, 'DCS'),
('EC6', 'Web Development Basics', 'diploma', 'Oct', 3, 'DCS'),
...
(1, 1, '09:00:00', '11:00:00', 'wednesday', 'lecture', 'EC4', 'S101', 'active', 2),
(2, 3, '11:00:00', '13:00:00', 'monday', 'lecture', 'EC7', 'S101', 'active', 2),
(14, 1, '08:00:00', '10:00:00', 'wednesday', 'lab', 'EC2', 'S102', 'active', 2),
(15, 2, '13:00:00', '15:00:00', 'thursday', 'lab', 'EC3', 'S102', 'active', 2),
(16, 1, '14:00:00', '16:00:00', 'tuesday', 'lab', 'EC9', 'S102', 'active', 2),
(17, 1, '09:00:00', '11:00:00', 'thursday', 'lecture', 'EC2', 'S101', 'active', 2),
(19, 1, '15:00:00', '17:00:00', 'friday', 'lab', 'EC9', 'S106', 'active', 2),
(32, 2, '15:00:00', '17:00:00', 'tuesday', 'lecture', 'EC3', 'S101', 'active', 2),
(33, 2, '08:00:00', '10:00:00', 'friday', 'lecture', 'EC3', 'S105', 'active', 2),
(48, 2, '14:00:00', '16:00:00', 'monday', 'lecture', 'EC3', 'S103', 'active', 2),
(310, 3, '15:00:00', '17:00:00', 'thursday', 'lab', 'EC1', 'S101011', 'active', 2),
(311, 3, '15:00:00', '17:00:00', 'friday', 'lecture', 'EC1', 'S101', 'active', 2);
...
--
ALTER TABLE `request`
  MODIFY `Reqid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `timetable`
--
ALTER TABLE `timetable`
  MODIFY `timetable_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=312;
...
--
ALTER TABLE `subject`
  ADD CONSTRAINT `fk_subject_lecturer` FOREIGN KEY (`lecid`) REFERENCES `lecturer` (`lec_id`) ON DELETE SET NULL ON UPDATE CASCADE;
